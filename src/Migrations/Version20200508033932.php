 ...
 */
final class Version20200508033932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cheese_listing ADD owner_id INT DEFAULT NULL, CHANGE price price INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cheese_listing DROP owner_id, CHANGE price price INT DEFAULT NULL');
